...
(function (global) {
  ...
  function injectCss() {
    ...
    var css = [
      ...
      P + '.mhead.dphead{position:relative;overflow:hidden;background:linear-gradient(110deg,#E8CC7A,#C9A84C 58%,#b8932f)}',
      P + '.mhead.dphead::before{content:"";position:absolute;inset:0;background:repeating-linear-gradient(118deg,transparent 0 7px,rgba(44,36,16,.13) 7px 8px)}',
