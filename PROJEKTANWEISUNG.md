...
|---|---|---|---|---|
| 13.08. | **Plan-Prüflauf (Punkt 6)** — alle drei Wahrheiten gegeneinander gehalten, kein Code geändert | (nur Backlog) | Matrizen **deckungsgleich** (31 Zeilen); **zwei Gate-Lecks** bei Free (`live_market_rates`, `market_data_fields`); `bank_pdf_premium` ist ein **toter Schlüssel** | DB-Weg (`Sub.hasCachedFeature`) und Partner brauchen echte Konten — offen |
