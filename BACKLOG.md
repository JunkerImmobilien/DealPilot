...
| 9 | Sprechlauf: Zustandswechsel, Barge-in, schlechte Verbindung (Latenz/Jitter/Reconnect), Mobile | Bau + Test | offen — baut auf Block C (C14 Zuhören) und D (Modelle) auf. **BLOCKIERT:** braucht Messungen im Browser (Kaskade, Handy-Breite, Mikrofon) — die Chrome-Erweiterung war am 18.09. nicht verbunden. |
