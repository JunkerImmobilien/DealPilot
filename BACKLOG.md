...
| 6 | Ist-/Soll-Modell + erweiterter MFH-Konfigurator (Einheiten) | Konzept | **STUFE 1+2 ERLEDIGT v1448 / v1451** (`e7d287c`, `576e170`) — Einheitenliste für MFH/ZFH/Gewerbe (Fläche, Einheiten, Ist-Kaltmiete übernehmen). Stufe 2: je Einheit Maßnahme + Kosten; Summe geht nur auf ausdrücklichen Haken in die Sanierung (ein vorhandener Betrag wird nie still überschrieben); im Ergebnis unter der Finanzierung die Tabelle **Ist gegen Soll** (Kaltmiete, Bruttorendite Ist auf KP / Soll auf GI, DSCR über `Dscr.compute()`, Leerstand, Maßnahmen). Im Browser: DSCR 1,83 → 2,17, Maßnahmen 30.000 €. **Offen:** Soll-Miete als Sprung in der Mietentwicklung, Ist/Soll ins Bank-PDF, Vererbung. |
...
| 21 | Light Mode Redesign für Steuerkanzleien — 5–6 Layout-Konzepte, **nichts implementieren** vor Auswahl | Konzept | **GEBAUT v1449–v1449d** (Marcels Wahl „Hybrid") — im hellen Profil (Vorlage kanzlei) ist die Objektliste eine kompakte Zeilenliste (300 px, 87 px je Zeile, aktives Objekt goldhell, gewonnene Deals grün markiert); ab 1500 px Breite rechts eine Aktionsspalte (Bankunterlagen, Investment-PDF Bank/normal, Marktbericht, Finanzamt-PDF, drei Kennzahlen des Objekts). Breiten erst ab 1025 px, Handy/Tablet unverändert. Gemessen in der Messkabine: keine Überlappung, kein Überlauf. Demo: https://claude.ai/artifact/5vWnSbZQsogMGfweKfJnRY |
