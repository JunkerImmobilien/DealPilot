...
| B2 | Sensible Rechenlogik ins Backend verschieben, soweit technisch möglich | **LÄUFT — v1360 bis v1365b.** Marcels Vorgabe „keine Einschränkungen" schließt die Serververlagerung des Scores vorerst aus (Latenz bei jeder Eingabe), also zuerst alles, was Schutz oder Konsistenz bringt, ohne etwas zu verändern. **v1360** Analyse-Prompt raus (167 Zeilen), Direktweg zu OpenAI zu. **v1361** zweiter § 32a-Tarif entfernt. **v1362/v1363** acht Score-Berechnungen je Eingabe auf zwei gesenkt — Voraussetzung für jede Verlagerung, denn das Limit liegt bei 100/Minute und die Serverrunde dauert 34 ms. **v1364** Tarif zentral, jahresbezogen, amtlich belegt für 2026. **v1365** der Rückfall im Quick-Check konnte nicht greifen (prüfte Existenz statt Ergebnis); **v1365b** er liefert bei identischen Eingaben 30 statt 15 und trägt jetzt einen sichtbaren Vermerk. **Offen und ehrlich gesagt: der Deal Score selbst lässt sich ohne Latenz nicht schützen** — das ist ein Zielkonflikt, keine offene Aufgabe. |
