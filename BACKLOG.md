...
| 12 | Deal-Aktionen „Ready für die Bank" heller und seriöser | Design | offen — Demo zuerst (Optik). **BLOCKIERT:** braucht Messungen im Browser (Kaskade, Handy-Breite, Mikrofon) — die Chrome-Erweiterung war am 18.09. nicht verbunden. |
| 13 | Deal-Score + Investor-Score hell/dunkel, folgt der globalen Einstellung | Design | offen — Demo zuerst (Optik); die Scores haben keine eigene Hell/Dunkel-Regel, die sich im Code allein bestimmen ließe. **BLOCKIERT:** braucht Messungen im Browser (Kaskade, Handy-Breite, Mikrofon) — die Chrome-Erweiterung war am 18.09. nicht verbunden. |
