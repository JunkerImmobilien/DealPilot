...
| A6 | Vorschlag: bessere Sortierung, weniger Reiter, was raus kann — **erst fragen, dann löschen** | **LISTE LIEGT MARCEL VOR (13.09.2026).** Kernbefund: „Profil & Anzeige" ist zwei Reiter in einem — fünf Blöcke Rechenvorgaben (fließen in jede Kalkulation) gegen neun Blöcke Darstellung (ändern keine Zahl). Dazu: Externe Anbieter mit einem Anbieter, Rechtliches als reiner Lesetext ohne Bedienelemente, „Investor Deal Score beim Öffnen" steht in einem anderen Reiter als der Deal Score, und zwei getrennte Schwellensysteme (Mindest-Schwellen unter Profil & Anzeige, Schwellenwerte unter Deal Score). **Nichts davon wird angefasst, bevor Marcel entschieden hat.** |
