...
| A9 | **PRE-FLIGHT nennt zwei Anbieter beim Namen** — ENTSCHEIDUNG OFFEN | Beim Screenshot der Objektansicht gefunden: in der PRE-FLIGHT-Karte stehen unter „Marktbewertung" die **Logos von Sprengnetter und PriceHubble** (`alt="Sprengnetter"`, `alt="PriceHubble"`, `img/sprengnetter.jpg`). CLAUDE.md ist eindeutig: beide werden nach außen nie namentlich genannt, ImmoMetrica darf. Ein Markenlogo ist eine namentliche Nennung — und diese steht prominenter als die Textstelle, die v1354 behoben hat. **Nicht angefasst:** die Karte ist ein zentrales Bedienelement, welche Quellen wie angeboten werden ist eine Produktentscheidung. |
