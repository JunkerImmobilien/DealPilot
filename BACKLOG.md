...
| B3 | Anomalie-Erkennung je Account (Frequenz, Regelmäßigkeit, Parametervariation, parallele Sitzungen, Limitüberschreitungen) | **BEGONNEN v1366 — die Zählung hängt jetzt am Konto.** Wer eingeloggt ist, wird unter seiner Nutzerkennung gezählt (600 pro Fenster), nicht mehr nach IP. Überschreitungen werden protokolliert (Konto, Pfad, Methode, Zeit) — **mehr bewusst nicht**, Marcels Auflage: eine technische Auffälligkeit ist kein bewiesener Verstoß. Messgrundlage steht: Normalnutzung trifft **12 Endpunktgruppen** bei Variationskoeffizient **5,13**, ein Skript ein bis zwei bei Streuung nahe null. **Offen:** Mustererkennung über die Zeit, Parametervariation, parallele Sitzungen. |
