...
| 6 | Ist-/Soll-Modell + erweiterter MFH-Konfigurator (Einheiten) | Konzept | **STUFEN 1–3 ERLEDIGT v1448 / v1451 / v1454** (`e7d287c`, `576e170`, `f9df9f1`) — Einheitenliste für MFH/ZFH/Gewerbe; Maßnahme + Kosten je Einheit (Summe nur auf Haken in die Sanierung); Kennzahlen **Ist gegen Soll** (Kaltmiete, Rendite Ist auf KP / Soll auf GI, DSCR über `Dscr.compute()`). **Stufe 3 (Marcel 20.09.2026):** das Modal hat vier Schritte — Gebäude, Einheiten, Zustand je Einheit, Ergebnis. Bewertet wird nach **Anlage 2 ImmoWertV** aus dem vorhandenen RND-Kern (`DealPilotRND.calcAll`, keine zweite Logik): Dach, Außenwand, Leitungen, Heizung gelten für das ganze Haus, Fenster/Bäder/Innenausbau/Grundriss **erbt jede Wohnung vom Gebäude**, bis sie widerspricht. Ergebnis: Punkte und Restnutzungsdauer je Einheit, flächengewichtet aufs Haus, auf Wunsch in `mod_punkte` und in die AfA (v1450). Im Browser: Bj 1968, Haus 8 P. → Wohnung 1 geerbt 8 P./37 J., Wohnung 2 mit eigenem Bad 12 P./41 J., gewichtet 10,1 P./39 J. → AfA 2,56 %. **Offen:** Soll-Miete als Sprung in der Mietentwicklung, Ist/Soll ins Bank-PDF. |
...
| 11 | Investment-PDF: **zusätzliche** helle Bank-Fassung, Vorbild Anschaffungskosten/Finanzamt-Dokument | Bau | **ERLEDIGT v1436** (`ef0c211`) — zusätzliche helle Bankfassung `exportPDFBank` neben dem bisherigen Investment-PDF, Einstieg in den Dokumenten und in der Hybrid-Aktionsspalte. (Zeile war nicht nachgezogen, 19.09.2026 korrigiert.) |
